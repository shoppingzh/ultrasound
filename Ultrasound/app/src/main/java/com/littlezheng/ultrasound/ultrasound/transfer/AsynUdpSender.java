...
public class AsynUdpSender implements UdpSender {
    ...
    public void addTrigger(DataReturner trigger) {
        trigger.addObserver(this);
    }

    public void addTriggers(DataReturner... triggers){
        if(triggers != null){
            for (DataReturner trigger : triggers){
                trigger.addObserver(this);
            }
        }
    }

    public void removeTrigger(DataReturner trigger) {
