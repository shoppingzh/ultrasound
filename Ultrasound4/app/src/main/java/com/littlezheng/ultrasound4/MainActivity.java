package com.littlezheng.ultrasound4;
...
import com.littlezheng.ultrasound4.adapter.FolderAdapter;
import com.littlezheng.ultrasound4.adapter.Snapshot;
import com.littlezheng.ultrasound4.adapter.SnapshotAdapter;
import com.littlezheng.ultrasound4.framework.graphics.measuremaker.LineMaker;
import com.littlezheng.ultrasound4.framework.graphics.measuremaker.RectMaker;
import com.littlezheng.ultrasound4.ultrasound.Configuration;
import com.littlezheng.ultrasound4.ultrasound.IApplication;
import com.littlezheng.ultrasound4.ultrasound.Resizeable;
import com.littlezheng.ultrasound4.ultrasound.SimpleApplication;
...
import com.littlezheng.ultrasound4.util.FileUtils;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, Resizeable {
...
//    private ImageButton pseudoColorBtn;

//    private ImageButton incContrastBtn;
//    private ImageButton decContrastBtn;
//    private ImageButton incLightnessBtn;
//    private ImageButton decLightnessBtn;
//    private ImageButton incGainBtn;
//    private ImageButton decGainBtn;
//    private ImageButton incNearGainBtn;
//    private ImageButton decNearGainBtn;
//    private ImageButton incFarGainBtn;
//    private ImageButton decFarGainBtn;
//    private ImageButton incDepthBtn;
//    private ImageButton decDepthBtn;


    private ViewGroup normalFunctionView;
    private ViewGroup paramsFunctionView;
...
//        freezeBtn = (ImageButton) findViewById(R.id.btn_freeze);
//        measureBtn = (ImageButton) findViewById(R.id.btn_measure);
//        imageBtn = (ImageButton) findViewById(R.id.btn_image);
//        videoBtn = (ImageButton) findViewById(R.id.btn_video);
//        modeBtn = (ImageButton) findViewById(R.id.btn_mode);
//        pseudoColorBtn = (ImageButton) findViewById(R.id.btn_pseudo_color);

//        incContrastBtn = (ImageButton) findViewById(R.id.btn_inc_contrast);
//        decContrastBtn = (ImageButton) findViewById(R.id.btn_dec_contrast);
//        incLightnessBtn = (ImageButton) findViewById(R.id.btn_inc_lightness);
//        decLightnessBtn = (ImageButton) findViewById(R.id.btn_dec_lightness);
//        incGainBtn = (ImageButton) findViewById(R.id.btn_inc_gain);
//        decGainBtn = (ImageButton) findViewById(R.id.btn_dec_gain);
//        incNearGainBtn = (ImageButton) findViewById(R.id.btn_inc_near_gain);
//        decNearGainBtn = (ImageButton) findViewById(R.id.btn_dec_near_gain);
//        incFarGainBtn = (ImageButton) findViewById(R.id.btn_inc_far_gain);
//        decFarGainBtn = (ImageButton) findViewById(R.id.btn_dec_far_gain);
//        incDepthBtn = (ImageButton) findViewById(R.id.btn_inc_depth);
//        decDepthBtn = (ImageButton) findViewById(R.id.btn_dec_depth);
        ...
        normalFunctionView = (ViewGroup) findViewById(R.id.layout_function_normal);
        paramsFunctionView = (ViewGroup) findViewById(R.id.layout_function_params);
        ...
        uContext = new UContext(new Configuration(this, "ultrasound.xml"));
        app = new SimpleApplication(uContext,
                (ViewGroup) findViewById(R.id.display_window_wrapper));
        freeze();
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()) {
                            case R.id.item_length:
                                app.startMeasure(new LineMaker());
                                break;
                            case R.id.item_area_per:
                                app.startMeasure(new RectMaker());
                                break;
                            case R.id.item_measure_backfat:
                                app.calculateAndDisplayBackFat();
                                break;
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()) {
                            case R.id.item_mode_b:
                                app.setMode(Mode.MODE_B);
                                break;
                            case R.id.item_mode_m:
                                app.setMode(Mode.MODE_M);
                                break;
                            case R.id.item_mode_bb:
                                app.setMode(Mode.MODE_BB);
                                break;
                            case R.id.item_mode_bm:
                                app.setMode(Mode.MODE_BM);
                                break;
                        }
                        return false;
                    }
    ...
    public void fullScreen() {
        ...
        normalFunctionView.startAnimation(disappearAnimation);
        normalFunctionView.setVisibility(View.GONE);
        paramsFunctionView.startAnimation(disappearAnimation);
        paramsFunctionView.setVisibility(View.GONE);
    ...
    public void noFullScreen() {
        ...
        disappearAnimation.setDuration(500);
        normalFunctionView.startAnimation(disappearAnimation);
        normalFunctionView.setVisibility(View.VISIBLE);
        paramsFunctionView.startAnimation(disappearAnimation);
        paramsFunctionView.setVisibility(View.VISIBLE);
    }
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                snapshotGridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        app.showSnapshot(new File(snapshot.getPathName()));
                        dialog2.dismiss();
                        dialog.dismiss();
                    }
                });
