...
public interface IApplication {
     ...
     * 拍摄屏幕快照
     * 将捕获当前屏幕并将快照保存到：
     * {@link com.littlezheng.ultrasound4.ultrasound.UContext#IMAGE_STORAGE_PATH}文件夹
     */
    void takeSnapshot();
     ...
     * {@link com.littlezheng.ultrasound4.ultrasound.UContext#VIDEO_STORAGE_PATH}文件夹
     */
    void saveVideo();
     ...
     * @param shapeMaker
     */
    void startMeasure(ShapeMaker shapeMaker);
