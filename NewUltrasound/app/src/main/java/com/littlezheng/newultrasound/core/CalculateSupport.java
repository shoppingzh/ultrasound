...
public class CalculateSupport {
     ...
     */
    public static void thirdSample(int[] pixels,
                                   byte[][] sourceData,
                                   int width,
                                   int height,
                                   int[][] positions,
...
//        Log.d(TAG, "处理B数据");
    ...
    public static void generateMImage(int[] pixels,
                                      byte[][] sourceData,
                                      int width,
                                      int height,
                                      int start,
...
//        long s = System.currentTimeMillis();
        ...
        for (int i = 0; i < height; i++) {
            for (int j = start; j < width; j++) {
                pixels[idx++] = colors[sourceData[j][i] & 0xff];
            }
